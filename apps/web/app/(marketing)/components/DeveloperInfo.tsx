...
export default function DeveloperInfo() {
  ...
  return (
    <div className="p-16 w-full md:w-[33%] flex flex-col gap-10 min-h-screen">
      {/* Profile Section */}
      ...
      <div className="space-y-1">
        <p className="text-lg">I turns ideas into solutions.</p>

        <div className="flex items-center gap-6 text-lg">
          <div className="flex items-center gap-2">
            <Box size={20} />
            <span className="font-semibold text-neutral-700">2 Products</span>
          </div>
          <div className="flex items-center gap-2">
            <Users size={20} />
